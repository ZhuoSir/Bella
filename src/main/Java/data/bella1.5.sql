...
-- ----------------------------
BEGIN;
INSERT INTO `bel_label` VALUES ('10001', 'Java', null, '四代编程语言', '1'), ('10002', 'Python', null, '现代编程语言', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bel_post` VALUES ('10001', '我爱你', '3', 'PyCharm 2017.1 正式发布了，新版有一个更快的调试器，改进的 Python 和 JavaScript 单元测试，并支持 six Library。其中，专业版对于 Web 开发也有了更大的支持，例如支持 Django, Flask，Pyramid，以及 Vue 等框架。\n\n部分更新内容：\n\nPython 调试器调试 Python 3.6 的项目快了四十倍，对于旧版本的 Python 来说，Python 调试器的速度提高了两倍', '1', '1', '0', null, '2017-05-31 15:35:51', null), ('10002', 'sss', '3', 'ould not find key \'spring.liveBeansView.mbeanDomain\' in any property source', '2', '2', '-1', null, '2017-05-31 20:49:17', null), ('10003', '是吗', '3', 'MYSQL中TIMESTAMP类型可以设定默认值，就像其他类型一样。', '3', '3', '-8', null, '2017-04-30 20:49:35', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bel_reply` VALUES ('1', '10001', '4', '我是大帅哥', '-9', '2017-03-26 21:34:59'), ('2', '10002', '4', 'hello world', '0', '2017-03-26 21:35:13'), ('3', '10001', '3', '兄弟们你们好吗', '-9', '2017-03-26 21:35:26'), ('4', '10001', '3', '是否接受的福建省地方了房价的房价的减肥的时间发大水', '0', '2017-03-26 21:35:39'), ('5', '10003', '4', '的说法了房间打开房间的房价的减肥的时间', '0', '2017-03-26 21:35:54');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `plat_admin` VALUES ('1', 'chen', 'oaiId5Os/BmRgqZJ6QXaqw==', '0', '1', '0', '2017-03-28 22:49:20'), ('2', 'zhang', '11111', '3', '1', '1', '2017-06-04 02:43:55'), ('3', 'LiYang', 'Y+WIMLtIQ5B0vZr/2kCdYQ==', '3', '1', '1', '2017-06-04 02:50:22');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `plat_func` VALUES ('1', '系统管理', 'linecons-cog', '', '0', '99', '1', '0', null, '测试。。。', null, '1'), ('2', '功能管理', null, '', '1', '1', '1', '1', '测试', null, '2017-03-07 21:15:52', '1'), ('3', '功能列表', '', 'Admin/func/list.do', '2', '1', '0', '0', null, '', null, '1'), ('4', '会员管理', 'linecons-user', '', '0', '0', '0', '0', null, '', null, '1'), ('5', '会员列表', '', 'Admin/member/list.do', '4', '0', '0', '0', null, '', '2017-03-13 23:34:47', '1'), ('6', '清空缓存', '', 'Admin/main/clearCache.do', '1', '99', '0', '0', null, '清空后端系统中的缓存数据', null, '1'), ('7', '帖子管理', 'fa-edit', '', '0', '1', '0', '0', null, '论坛帖子管理', null, '1'), ('8', '帖子列表', '', 'Admin/post/list.do', '7', '0', '0', '0', null, '', '2017-03-26 19:00:36', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `web_navigation` VALUES ('1', '科技', '0', '2017-07-27 14:53:13', '0', '1', null), ('2', '军事', '0', '2017-07-27 14:53:23', '0', '2', null), ('3', 'Java', '0', '2017-07-27 15:14:05', '0', '99', null);
COMMIT;
