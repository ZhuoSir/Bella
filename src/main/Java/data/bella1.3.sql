...
CREATE TABLE `bel_post` (
  ...
  `status` int(8) DEFAULT '0' COMMENT '帖子状态：0 正常发布，-8 禁止回复，-9 删除',
...
-- ----------------------------
BEGIN;
INSERT INTO `bel_post` VALUES ('10001', '我爱你', '3', 'PyCharm 2017.1 正式发布了，新版有一个更快的调试器，改进的 Python 和 JavaScript 单元测试，并支持 six Library。其中，专业版对于 Web 开发也有了更大的支持，例如支持 Django, Flask，Pyramid，以及 Vue 等框架。\n\n部分更新内容：\n\nPython 调试器调试 Python 3.6 的项目快了四十倍，对于旧版本的 Python 来说，Python 调试器的速度提高了两倍', '1', '1', '0', null, '2017-03-26 15:35:51', null), ('10002', '孙桂青', '3', 'ould not find key \'spring.liveBeansView.mbeanDomain\' in any property source', '2', '2', '0', null, '2017-03-26 20:49:17', null), ('10003', '是吗', '3', 'MYSQL中TIMESTAMP类型可以设定默认值，就像其他类型一样。', '3', '3', '0', null, '2017-03-26 20:49:35', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bel_reply` VALUES ('1', '10001', '4', '我是大帅哥', '0', '2017-03-26 21:34:59'), ('2', '10002', '4', 'hello world', '0', '2017-03-26 21:35:13'), ('3', '10001', '3', '兄弟们你们好吗', '0', '2017-03-26 21:35:26'), ('4', '10001', '3', '是否接受的福建省地方了房价的房价的减肥的时间发大水', '0', '2017-03-26 21:35:39'), ('5', '10003', '4', '的说法了房间打开房间的房价的减肥的时间', '0', '2017-03-26 21:35:54');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `member` VALUES ('3', 'member001', '陈卓', 'sfj33r190-fn2k3nr1r', '263596836@qq.com', '2017-02-28 11:41:42', '0', null, '18456239658', 'sunny'), ('4', 'member002', '小王', 'sfj33r190-fn2k3nr1r', '231332@qq.com', '2017-03-26 15:26:58', '1', null, '18726784578', 'kitty');
COMMIT;
