...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`index`,`accountID`,`accountName`,`email`),
  KEY `ID` (`index`)
...
CREATE TABLE `member_info` (
  ...
  CONSTRAINT `member_info_ibfk_1` FOREIGN KEY (`MemberID`) REFERENCES `member` (`index`)
...
CREATE TABLE `web_member` (
  ...
  CONSTRAINT `web_member_ibfk_1` FOREIGN KEY (`memberUserID`) REFERENCES `member` (`index`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
